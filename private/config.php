...
const DB_NAME = 'uXXXXXXXX_tgfm';
const DB_USER = 'uXXXXXXXX_tgfm';
...
const MAYA_PUBLIC_KEY_SANDBOX = 'REPLACE-ME';
const MAYA_SECRET_KEY_SANDBOX = 'REPLACE-ME';
...
const PLANS = [
    'week'  => ['name' => 'Weekly Pass',       'price' =>  140.00, 'period' => 'week',  'span' => '7 days'],
    'month' => ['name' => 'Monthly Access',    'price' =>  499.00, 'period' => 'month', 'span' => '1 month'],
    'year'  => ['name' => 'Annual Membership', 'price' => 4990.00, 'period' => 'year',  'span' => '1 year'],
];
const CURRENCY = 'PHP';
...
const MAIL_SMTP_HOST   = '';                        // e.g. 'smtp.hostinger.com'
const MAIL_SMTP_PORT   = 465;
const MAIL_SMTP_SECURE = 'ssl';                     // 'ssl' for 465, 'tls' for 587
const MAIL_SMTP_USER   = '';                        // the full mailbox address
const MAIL_SMTP_PASS   = '';                        // its password
...
const MAIL_FROM_NAME  = 'TGFM Discipleship Trainings';
